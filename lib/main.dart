...
import 'package:yuana_salary/app_color.dart';
import 'package:yuana_salary/create_task_screen.dart';
import 'package:yuana_salary/widget_background.dart';
        ...
        onPressed: () async {
          ...
          if (result != null && result) {
            scaffoldState.currentState.showSnackBar(SnackBar(
              content: Text('Salary has been created'),
            ));
            setState(() {});
          }
        },
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    int total_harga = task['jumlah'] * task['ongkos'];
                    String strDate = task['date'];
                    
                    final oCcy = new NumberFormat("#,##0.00", "en_US");
                    String formatted = oCcy.format(total_harga);
                        ...
                        trailing: PopupMenuButton(
                          ...
                          onSelected: (String value) async {
                            if (value == 'edit') {
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState.showSnackBar(SnackBar(
                                  content: Text('Salary has been updated'),
                                ));
                                setState(() {});
                              }
